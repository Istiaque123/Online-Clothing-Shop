...
// */
  ...
  async function fetchProducts() {
    try {
        ...
        // Remove _id field from each product and ensure reviews object exists
        const productsWithoutId = products.map((product, index) => ({
            ...
            reviews: product.reviews || {}  // Ensure reviews object exists, default to empty object if not provided
        }));
...
export const cardsDataTwo = fetchProducts();


if(cardsData == cardsDataTwo){
    console.log('Yes');
}
else{
    console.log('No');
